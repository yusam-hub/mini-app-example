...
class TjsDialogMsg extends TjsMsg
{
    constructor(options = {})
    {
        super(options);
     ...
     */
    dialogInputForm(jsForm, newOptions = {}) {
     ...
     * @param newOptions object
     */
    dialogInputFormConfirm(jsForm, newOptions = {}) {
     ...
     * @param newOptions object
     */
    dialogInputFormConfirmAdd(jsForm, newOptions = {}) {
     ...
     * @param newOptions object
     */
    dialogInputFormConfirmSave(jsForm, newOptions = {}) {
     ...
     * @param newOptions object
     */
    dialogInputFormConfirmDelete(jsForm, newOptions = {})
    {
        let self = this;
        self.dialogInputFormConfirm(jsForm, {
