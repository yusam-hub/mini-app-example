 ...
 * @returns {string}
 */
String.prototype.jsRtrim = function(s) {
    if (s === undefined) {
        s = '\\s';
    }
 ...
 * @returns {string}
 */
String.prototype.jsLtrim = function(s) {
    if (s === undefined) {
        s = '\\s';
    }
    return this.replace(new RegExp("^[" + s + "]*"), '');
 ...
 * @returns {string}
 */
String.prototype.jsSeparateLeft = function(separator) {
    let arr = this.split(separator);
    return arr.length > 0 ? this.split(separator)[0] : '';
};
 ...
 * @returns {string}
 */
String.prototype.jsSeparateRight = function(separator) {
    let arr = this.split(separator);
    return arr.length > 1 ? this.split(separator)[1] : '';
};
 ...
 * @returns {string}
 */
String.prototype.jsMd5 = function(){
 ...
 * @returns {string}
 */
String.prototype.jsNl2br = function() {
 ...
 * @returns {string}
 */
String.prototype.jsBr2nl = function() {
    return String(this).replace(/<br>/g, "\r");
};